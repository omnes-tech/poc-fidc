  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          Manager Portal (Validator & Payable)
        </Link>
      </div>

      <p className="mt-8 text-center text-gray-600 max-w-md">
        This platform demonstrates how a FIDC (Fundo de Investimento em Direitos
        Creditórios) operates on the blockchain, from initialization to
