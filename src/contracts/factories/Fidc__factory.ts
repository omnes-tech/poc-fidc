...
import type { Fidc, FidcInterface } from "../Fidc";
...
export class Fidc__factory {
  static readonly abi = _abi;
  static createInterface(): FidcInterface {
    return new Interface(_abi) as FidcInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Fidc {
    return new Contract(address, _abi, runner) as unknown as Fidc;
  }
}
