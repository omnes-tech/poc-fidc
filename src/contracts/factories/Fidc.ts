...
export interface FidcInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "fidcTotalInvested",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getFIDCTotalInvested",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Fidc extends BaseContract {
  ...
  fidcTotalInvested: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "fidcTotalInvested"
  ): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "getFIDCTotalInvested"
  ): TypedContractMethod<[_fidcId: BigNumberish], [bigint], "view">;
  getFunction(
