const fidc_abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "isSenior", type: "bool" },
      {
        indexed: false,
        internalType: "uint256",
        name: "investmentDate",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "fidicId", type: "uint256" },
  ...
  },
  {
    ...
    name: "initializeFIDC",
    outputs: [{ internalType: "uint256", name: "fidicId", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
