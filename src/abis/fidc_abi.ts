const fidc_abi = [
  ...
  },
  {
    ...
    inputs: [
      { name: "_pj", type: "address", internalType: "address" },
      { name: "_fidcId", type: "uint256", internalType: "uint256" },
      { name: "_scheduleAmount", type: "uint256", internalType: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      { name: "_fidcId", type: "uint256", internalType: "uint256" },
      { name: "_investmentId", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [
      { name: "_fidcId", type: "uint256", internalType: "uint256" },
      { name: "_investors", type: "address[]", internalType: "address[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  { type: "error", name: "GracePeriodNotEnded", inputs: [] },
  { type: "error", name: "InsufficientBalance", inputs: [] },
  { type: "error", name: "InsufficientFIDCAmount", inputs: [] },
  ...
  { type: "error", name: "InvestmentNotFound", inputs: [] },
  { type: "error", name: "NoLeftoverAmount", inputs: [] },
  ...
  { type: "error", name: "ValidationFailed", inputs: [] },
